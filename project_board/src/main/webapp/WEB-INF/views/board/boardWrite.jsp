...
/* 	$(".delBtn").click(function(){
	...
	//최대 크기 
	var maxSize = 1048579; //3*1024*1024==1MB
	//파일 크기
		...
		<form method="post" name="boardForm" id="boardForm" action="boardWriteOk" enctype="multipart/form-data">
			...
			<ul>
				...
				<li>
					...
					<textarea id="summernote" class="content"  name="content" title="content"  rows="10" cols="" maxlength="500"  oninput="lengthCheck()"></textarea >
